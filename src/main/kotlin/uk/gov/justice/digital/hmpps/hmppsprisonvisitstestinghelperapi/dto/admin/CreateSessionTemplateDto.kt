...
data class CreateSessionTemplateDto(
  ...
  @param:Schema(description = "The start and end time of the generated visit session(s)", required = true)
  val sessionTimeSlot: SessionTimeSlotDto,

  @param:Schema(description = "The start and end date of the Validity period for the session template", required = true)
  ...
  @param:Schema(description = "The open and closed capacity of the session template", required = true)
  @field:Valid
  val sessionCapacity: SessionCapacityDto,

  @param:Schema(description = "day of week fpr visit", example = "MONDAY", required = true)
